...
### 📎 Attachments
1. Wireshark screenshots (TCP handshake, retransmissions)
...
3. ![alt text](<Failed connections.png>)
No SYN-ACK received 
...
4. ![alt text](<to and from ip 45.33.32.156.png>)
...
- NIC setting Speed & Duplex changed from auto to 1 Gbps and target host was re-ran ping test
Results showed stable latency and reduced retransmissions.

---

This case reinforced the importance of verifying duplex settings and interpreting TCP flags in packet analysis. It also demonstrated how ephemeral ports and retransmissions can signal deeper network or security issues.
